...
$admincp_actions_normal = array('index', 'setting', 'members', 'profilefields', 'admingroup', 'usergroups',
	...
	'district', 'diytemplate', 'verify', 'nav', 'domain', 'postcomment', 'tag', 'connect', 'card', 'comp','auto', 'apply', 'recommend','shoujibao','jdt','realbum','baofen','tianyi','join','badge','scommend','course');/*增加comp 相应增加source\admincp\admincp_comp.php文件*/
