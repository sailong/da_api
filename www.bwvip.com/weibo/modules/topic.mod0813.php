	...
	function Main()
	{
		...
		//徐玉枭添加球星和赛事				
				...
				$groupid = DB::result_first("SELECT groupid FROM pre_common_member WHERE uid='{$uid}' ");
					...
					if((($groupid==24)||($groupid==25))&&MEMBER_ID>0){
					 $ispublish =1;
					}
	...
	function Follow()
	{
    	...
    	if (!empty($keyword)) {
		   ...
		   /*强制关注人名单 angf do it 2012/6/7*/
            ...
            if(!$checking){
                $uids =array('1000170','100033','1000348','1629','1899467','1000139','1889006','1160','1000136','1888898','1000411','1889669','1888968','1888967','1888969','1889013','1000399','1000872','1889180','1888972','1000800','1000457','1899231','1899475','1000931');
                foreach($uids as $id){
