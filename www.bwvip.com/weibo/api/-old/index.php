...
<div><img src="<?php echo $v['face']; ?>" /><?php echo $v['nickname']; ?> : <?php echo $v['content']; if($v['image_list']) { foreach($v['image_list'] as $iv) { ?><a href="<?php echo str_replace("/t2/images/","/weibo/images/", $iv['image_original']) ?>"><img src="<?php echo str_replace("/t2/images/","/weibo/images/", $iv['image_small']); ?>" /></a><?php } ?> - <?php echo $v['from_string']; ?></div><hr />
