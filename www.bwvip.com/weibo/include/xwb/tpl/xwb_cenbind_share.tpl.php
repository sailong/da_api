...
<div class="bind-setting xwb-plugin">
	<p class="alert-tips">与新浪微博绑定成功！</p>
    <div class="bing-text">
    	<h4>您现在可以：</h4>
        <p>使用新浪微博帐号登录 <?php echo XWB_S_TITLE;?>，不用担心忘记密码</p>
        <p>在 <?php echo XWB_S_TITLE;?> 发微博同步发到新浪微博上，吸引更多人关注</p>
    </div>
    <p class="txtb">&nbsp;<a href="<?php echo XWB_plugin::URL('xwbSiteInterface.bind&share=1');?>"><strong>发一条微博告诉我的朋友</strong></a>&nbsp;&nbsp;<a href="<?php echo XWB_plugin::URL('xwbSiteInterface.bind&skip_share=1');?>">或者点此直接进入设置页面</a>&nbsp;</p>
</div>
