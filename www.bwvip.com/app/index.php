...
$android_url=DB::result_first("select app_version_url from tbl_app_version where app_version_type='android' and field_uid=0 order by app_version_addtime desc limit 1 ");
if(!$android_url)
{
...
<body>
<table width="100%" height="650" border="0" cellspacing="0" cellpadding="0" style="background:url(images/pic1.gif) center top no-repeat;">
  <tr>
    <td align="center"  style="height:400px;"></td>
  </tr>
  <tr>
    <td align="center" style="height:120px;"><a href="https://itunes.apple.com/us/app/da-zheng-gao-er-fu-golf/id642016024?ls=1&mt=8" target="_blank"><img src="images/iphone.gif" alt="" width="379" height="103" /></a></td>
  </tr>
