...
$member_sql = "select realname from pre_common_member_profile where uid='{$uid}'";
$member_info = DB::fetch_first($member_sql);
$member_info['touxiang'] = "http://www.bwvip.com/uc_server/avatar.php?uid=".$uid."&size=small";//http://www.bwvip.com/uc_server/avatar.php?uid=1889013&size=middle
...
include_once template("wap/news_detailbak");
