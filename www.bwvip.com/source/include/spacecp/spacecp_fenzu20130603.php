...
$defaultop = 'base';
$operation = in_array($_GET['op'], array('base', 'members_fenzu', 'm_fenzu_submit', 'event_fenzu_rule_list', 'del_rule', 'member_allot', 'start_nd', 'stopgame')) ? trim($_GET['op']) : $defaultop;
