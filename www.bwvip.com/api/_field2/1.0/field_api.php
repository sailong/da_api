...
if($ac=="field_intro")
{
	...
	if($field_uid && $type)
	{
		$detail_data=DB::fetch_first("select about_id,about_id as blogid,about_name as arc_name,about_replynum as arc_replynum,about_addtime as dateline,about_content as content,about_tel as tel,about_tel2 from tbl_field_about where about_type='".$type."' and field_uid='".$field_uid."' ".$language_sql." limit 1 ");
