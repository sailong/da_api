...
//记事狗微博服务端的API地址
define('JISHIGOU_API_SITE_URL',		'http://www.bwvip.com/weibo/api.php');
//记事狗微博分配的APP KEY
...
define('JISHIGOU_API_USERNAME',		'大正管理员');
//记事狗微博上加密后的密码 
//需要将密码中的用户昵称和密码转换成网站编码一致的字符再进行md5
define('JISHIGOU_API_PASSWORD',	md5('大正管理员'.md5(iconv('utf-8','gbk','dz@bwvip'))));
