 ...
 *    @Date			2013-07-02
 */
class push_devicesAction extends AdminAuthAction
{
	...
	public function push_devices_add_action()
	{
		if(M()->autoCheckToken($_POST))
		{
			...
			$this->success("添加成功",U('admin/push_devices/push_devices'));
		}
		else
		{
			$this->error("不能重复提交",U('admin/push_devices/push_devices_add'));
		}
	...
	public function push_devices_edit_action()
	{
		if(M()->autoCheckToken($_POST))
		{
			...
			$this->success("修改成功",U('admin/push_devices/push_devices'));			
		}
		else
		{
			$this->error("不能重复提交",U('admin/push_devices/push_devices'));
		}
