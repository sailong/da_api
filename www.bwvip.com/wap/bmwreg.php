...
<?php }?>
           ...
           <select name="month" id="month">
             <option value="0">请选择</option>  <?php for ($i=0; $i<=12; $i++) { ?>
...
<select name="day" id="day">
  <option value="0">请选择</option><?php for ($i=0; $i<=31; $i++) { ?>
             <option value="<?php echo 1+$i;?>"><?php echo 1+$i;?></option>
...
*</td>
      ...
      <tr>
       ...
       <tr>
         <td><label for="is_contact"><input name="is_contact" type="checkbox" id="is_contact" value="1" checked>
