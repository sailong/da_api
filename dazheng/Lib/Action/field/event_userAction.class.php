 ...
 *    @Date			2013-08-13
 */
class event_userAction extends field_publicAction
{
	...
	public function event_user_add_action()
	{
		if(M()->autoCheckToken($_POST))
		{
			...
			$this->success("添加成功",U('field/event_user/event_user',array('event_id'=>post('event_id'))));
		}
		else
		{
			$this->error("不能重复提交",U('field/event_user/event_user_add',array('event_id'=>post('event_id'))));
		}
	...
	public function event_user_edit_action()
	{
		if(M()->autoCheckToken($_POST))
		{
			...
			$this->success("修改成功",U('field/event_user/event_user',array('event_id'=>post('event_id'))));			
		}
		else
		{
			$this->error("不能重复提交",U('field/event_user/event_user',array('event_id'=>post('event_id'))));
		}
