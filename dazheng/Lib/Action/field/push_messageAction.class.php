 ...
 */
class push_messageAction extends field_publicAction
{
	...
	public function push_message()
	{
		...
		*/
		...
		$list=D("push_message")->push_message_list_pro(" and field_uid='".$_SESSION['field_uid']."' ");
		...
		if(M()->autoCheckToken($_POST))
		{
			...
			*/
			...
			if($list!=false)
			{
				...
				$this->success("添加成功",U('field/push_message/push_message'));
			}
			else
			{				
				$this->error("添加失败",U('field/push_message/push_message'));
			}
		}
		else
		{
	...
	public function push_message_edit_action()
	{
		if(M()->autoCheckToken($_POST))
		{
			...
			if($list!=false)
			{
				$this->success("修改成功",U('field/push_message/push_message'));
			}
			else
			{
				$this->error("修改失败",U('field/push_message/push_message'));
			}
		}
		else
		{
