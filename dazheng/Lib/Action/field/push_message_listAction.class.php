 ...
 *    @Date			2013-07-02
 */
class push_message_listAction extends field_publicAction
{
	...
	{
		$list=D("push_message_list")->push_message_list_list_pro(" and field_uid='".$_SESSION['field_uid']."' ");
	...
	public function push_message_list_add_action()
	{
		if(M()->autoCheckToken($_POST))
		{
			...
			$this->success("添加成功",U('field/push_message_list/push_message_list'));
		}
		else
		{
			$this->error("不能重复提交",U('field/push_message_list/push_message_list_add'));
		}
	...
	public function push_message_list_edit_action()
	{
		if(M()->autoCheckToken($_POST))
		{
			...
			$this->success("修改成功",U('field/push_message_list/push_message_list'));			
		}
		else
		{
			$this->error("不能重复提交",U('field/push_message_list/push_message_list'));
		}
