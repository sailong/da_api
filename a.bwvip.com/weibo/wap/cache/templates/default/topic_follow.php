...
<?php if(is_array($member_list)) { foreach($member_list as $val) { ?>
											<div style="padding:2px;">
												<div class="t_list_b" >
													<span>
														<a href="index.php?mod=getuinfo&uid=<?php echo $val['uid']; ?>"><?php echo $val['nickname']; ?></a>
													</span>
...
<?php } ?>
												...
												<div class="t_list_b" style="color:#666666;">
												 ...
												 <span><a href="index.php?mod=pm&code=pmsend&amp;nickname=<?php echo $val['nickname']; ?>">发私信</a></span>
												</div>
											 </div>
