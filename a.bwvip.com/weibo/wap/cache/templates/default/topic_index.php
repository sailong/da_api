											  ...
											  <div>
												<div>
												  ...
												  <div>
													<!--微博主体-->
													<div>
													  <div> <span><a href="index.php?mod=getuinfo&uid=<?php echo $val['uid']; ?>"><?php echo $val['nickname']; ?></a>
  ...
  <!--列表区块开始-->
											  <div>
												<div style="padding:2px;">
												  <div class="t_list_b">
													<!--微博主体-->
													<div> <a title="<?php echo $val['username']; ?>" href="index.php?mod=getuinfo&uid=<?php echo $val['uid']; ?>"><?php echo $val['nickname']; ?></a>
