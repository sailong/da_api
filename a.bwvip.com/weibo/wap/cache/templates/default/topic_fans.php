...
<?php } ?></div>
					   <div class="nav_u">
							   <ul>																
										...
										<div>
<?php if(MEMBER_ID) { ?>
<!--（<span><a href="index.php?mod=profile&amp;code=invite" target="_blank">邀请好友</a>来关注</span>）-->
<?php } ?>
</div>
...
<?php if($this->Code == 'fans') $fans_hb = 'hb'; ?>
											...
											<span class="<?php echo $follow_hb; ?>"><a href="index.php?mod=topic&code=follow">我关注的</a></span>
											<span class="<?php echo $fans_hb; ?>" style="margin-left:10px;"><a href="index.php?mod=topic&code=fans">关注我的</a> </span>
										</div>
...
<?php if(is_array($member_list)) { foreach($member_list as $val) { ?>
										<div style="padding:2px;">
											<div class="t_list_b">
												<span><a href="index.php?mod=getuinfo&uid=<?php echo $val['uid']; ?>"><?php echo $val['nickname']; ?></a></span>
...
<?php } ?>
											...
											<div class="t_list_b" style="color:#666666;">
											 <span>关注<?php echo $val['follow_count']; ?>人 |</span> 
											 <span>粉丝<?php echo $val['fans_count']; ?>人 |</span> 
											 <span>微博<?php echo $val['topic_count']; ?>条</span>
											</div>
											<div class="lineDot"></div>
										</div>
										
<?php } } ?>
<?php if($member['fans_count']<7) { ?>
										<div class="t_list_b">
										所有关注<?php echo $member['username']; ?>的人，都能在其个人首页中第一时间看到其发布的信息<br />
										通过发布有价值的信息，或者评论转发他人的微博，将会吸引更多的人关注
<?php if(MEMBER_ID > 0) { ?>
，马上进入<a href="index.php?mod=topic&amp;code=myhome">我的首页</a>分享新鲜事吧
<?php } ?>
</div>
