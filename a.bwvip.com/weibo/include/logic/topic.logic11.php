...
$fansurl='home.php?mod=space&do=common&op=topic&code='.$tid;
...
$feed = array(); 
$feed['icon']='topic';
$feed['title_template'] = '<a href="'.$fansurl.'">添加一条微博</a>'; 
$feed['uid']=$data['uid'];
...
//uc_feed_add($feed['icon'], $data['uid'],  $data['username'], $feed['title_template'], $feed['title_data'], $feed['body_template'], $feed['body_data'], '', '',$feed['images']); 
    ...
    function Make($topic, $actors = array())
    {
        ...
        if ($topic['imageid'])
        { 
		/*	if($topic['imageid']<17987&&$topic['imageid']>10004)
			  {
				 $id1=$topic['imageid']-10000;
				}else{
				 $id1=$topic['imageid'];
				}*/
               $id1=$topic['imageid'];          
			...
			$topic['image_list'] = $ImageLogic->image_list($id1);
        }
