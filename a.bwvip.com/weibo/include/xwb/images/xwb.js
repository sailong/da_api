 ...
 */
    ...
    _loadStyle : function(){
      NS.util.loadStyle([
        ...
        '.xwb_ui_focus .ui_title_text{background-color:#6699CC}',
        ...
        '.xwb_ui_focus .ui_close{border:1px solid #6699CC}',
    ...
    updateContent : function(data) {
        ...
        this.layerCt.innerHTML = NS.util.templ([
                            '<div class="info-card-pic">',
                                '<a target="_blank" href="http://t.sina.com.cn/{sina_uid}"><img width="50" height="50" src="{profile_image_url}" /></a>',
                            ...
                            '<div class="info-coard-main">',
                                '<a class="xwb-username" target="_blank" href="http://t.sina.com.cn/{sina_uid}">{sina_name}</a>',
...
NS.util.domEvent(window, 'load', function(){
    ...
    if( NS.isPage('home_spacecp') ){
        ...
        NS.profile = {
                 ...
                 */
            	setXwbSigner : function(uid, skinNum){
            	  var tpl = this.getSignerSkinTpl(uid, skinNum);
                 ...
                 * @param {String} skinNumber 皮肤下标
                 */
                getSignerSkinTpl : function(uid, skinNum){
                    return '<-sina_sign,'+uid+','+skinNum+'->';
                },
        		 ...
        		 */
            	onSignerDlgOk : function(uid, skinNum){
            	  this.setXwbSigner(uid, skinNum);
            	  NS.close('signer');
            	}
        };        
    }
