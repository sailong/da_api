...
<div class="bind-setting xwb-plugin">
	<div class="setting-box">    	
        ...
        <h3>读取新浪微博的内容到<?php echo XWB_S_TITLE;?></h3>
        <div class="radio-box">
        ...
        <h3>读取微博的评论内容到<?php echo XWB_S_TITLE;?></h3>
        <div class="radio-box">
    ...
    <div class="setting-box">
        <form id="unbindFrm" action="<?php echo XWB_plugin::URL('xwbSiteInterface.unbind');?>" method="post" target="xwbSiteRegister" >
			<input type="hidden" name="FORMHASH" value="<?php echo FORMHASH; ?>" />
			<p>您已绑定新浪微博帐号昵称为：<a target="_blank" href="http://t.sina.com.cn/<?php echo $sina_id;?>"><?php echo $screen_name;?></a></p>
			...
			<p class="tips">解除绑定后，您在&nbsp;<?php echo XWB_S_TITLE; ?>&nbsp;发表的内容将不再同步到新浪微博</p>
		</form>
    </div>
</div>
