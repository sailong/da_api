...
class ModuleObject extends MasterObject
{
	...
	function Main()
	{
		...
		include($this->TemplateHandler->Template('daz_search_list'));
	}
	...
	function UserSearch()
	{
		...
		$per_page_num = 10;
		$query_link = 'index.php?mod=daz_search&code=user';
    ...
    function UserTagSearch()
  {
	...
	function TopicSearch()
	{
				...
				if(MEMBER_STYLE_THREE_TOL)
		{
 		...
 		$per_page_num = 10;
		$query_link = 'index.php?mod=daz_search&code=topic';
		...
		function TagSearch()
	{
		$per_page_num = 10;
		$topic_parent_disable = false;
		$query_link = 'index.php?mod=daz_search&code=tag';
