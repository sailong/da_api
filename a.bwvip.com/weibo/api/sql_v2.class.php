 ...
 * 数据库类
  *
 * @version        sql_v2.class.php 2012-02-22 am 09:41
 * @about			jack 2012
...
//if(!defined('INC_ROOT')) exit("Request Error!");

$cfg_dbhost="localhost";
$cfg_dbuser="dfykadmin";
$cfg_dbpwd="hahavipbw(*)";
$cfg_dbname="ultrax";
$cfg_dbprefix="jishigou";
$cfg_db_language="utf8";

$GLOBALS['cfg_dbhost']=$cfg_dbhost;
$GLOBALS['cfg_dbuser']=$cfg_dbuser;
$GLOBALS['cfg_dbpwd']=$cfg_dbpwd;
$GLOBALS['cfg_dbname']=$cfg_dbname;
$GLOBALS['cfg_dbprefix']=$cfg_dbprefix;
$GLOBALS['cfg_db_language']=$cfg_db_language;


// 在工程所有文件中均不需要单独初始化这个类，可直接用 $dsql 或 $db 进行操作
// 为了防止错误，操作完后不必关闭数据库

$dsql = $db = new JackSql(FALSE);
...
class JackSql
{
    ...
    function JackSql($pconnect=FALSE,$nconnect=TRUE)
    {
