 ...
 *    @Date			2013-05-29
 */
class baofen_userAction extends field_publicAction
{
	...
	public function baofen_user_add_action()
	{
		...
		if(M()->autoCheckToken($_POST))
		{
			...
			$this->success("添加成功",U('field/baofen_user/baofen_user',array('event_id'=>$data["event_id"])));
		}
		else
		{
			$this->error("不能重复提交",U('field/baofen_user/baofen_user_add',array('event_id'=>$data["event_id"])));
		}
	}
	...
	public function baofen_user_edit_action()
	{
		if(M()->autoCheckToken($_POST))
		{
			...
			$this->success("修改成功",U('field/baofen_user/baofen_user',array('event_id'=>$data["event_id"])));
		}
		else
		{
			$this->error("不能重复提交",U('field/baofen_user/baofen_user',array('event_id'=>$data["event_id"])));
		}
