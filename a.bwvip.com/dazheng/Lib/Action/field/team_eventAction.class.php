 ...
 *    @Date			2013-05-28
 */
class team_eventAction extends field_publicAction
{
	...
	public function team_event_add()
	{
	...
	public function team_event_add_action()
	{
	...
	public function team_event_edit()
	{
	...
	public function team_event_edit_action()
	{
		if(M()->autoCheckToken($_POST))
		{
	...
	public function team_event_delete_action()
	{
		if(post("ids"))
		{
	...
	public function team_event_detail()
	{
		if(intval(get("event_id"))>0)
		{
			$data=M("event")->where("event_id=".intval(get("event_id")))->find();
	...
	public function team_event_manage()
	{
		if(intval(get("event_id"))>0)
		{
