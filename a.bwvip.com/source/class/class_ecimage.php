...
class cls_image
{
	...
	public $myurl="/home.php?mod=spacecp&ac=shopping";
    ...
    function upload_image($upload, $dir = '', $img_name = '')
    {
		...
		if($upload['size']>2000000){
			showmessage("图片必须2M以内",$this->myurl);
		}
