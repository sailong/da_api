...
if($_GET['op'] == 'delete') {
	...
	switch ($type) {
		case 'space':
			...
			$arr['body_data'] = array(
			'username' => "<a href=\"home.php?mod=space&uid=$id\">".getrname($id)."</a>",
		...
		case 'blog':
			...
			'username' => "<a href=\"home.php?mod=space&uid=$blog[uid]\">".getrname($blog['uid'])."</a>",
		...
		case 'album':
			...
			$arr['body_data'] = array(
				...
				'username' => "<a href=\"home.php?mod=space&uid=$album[uid]\">".getrname($album['uid'])."</a>"
			);
		...
		case 'pic':
			...
			'username' => "<a href=\"home.php?mod=space&uid=$pic[uid]\">".getrname($pic['uid'])."</a>",
		...
		case 'article':
			...
			'username' => "<a href=\"home.php?mod=space&uid=$article[uid]\">".getrname($article['uid'])."</a>",
