...
/*接口mod 对应的 接口文件*/
$modarray = array('register', 'login','field','ad','club','system','user','finance','message','score','event','manage_event','manage_event1','wap','go','reg_activate');
...
if(!$no_token)
{
	...
	{
		api_json_result(0,88888,'token error',null);
	}
}
