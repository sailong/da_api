 ...
 * @Package JishiGou $
 *
 * @Filename admin_script_common.js $
 *
 * @Author http://www.jishigou.net $
 *
 * @Date 2012-04-23 17:49:36 1633621666 1155936834 26453 $
 *******************************************************************/
...
function del_item(obj,oid)
{
	...
	if(oid > 0){
		$.post("ajax.php?mod=item&code=del",{id:oid}, function(){});
	}
	o.parentNode.removeChild(o);
}
...
function add_item(obj,item,itemid,type)
{
	...
	if(nickname.length == 0){
		...
		$.post("ajax.php?mod=item&code=checkname",{nickname:nickname,item:item,itemid:itemid}, function(d){
		if(d == -1){
			MessageBox('notice', "该用户已经存在！", '提示');
		}else if(d == -2){
