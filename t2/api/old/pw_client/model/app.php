 ...
 *
 * @Date 2012-04-23 17:49:34 1926201464 1810323948 3901 $
 *******************************************************************/
...
class appmodel {
	...
	function ucfopen($url, $interface, $apikey, $mode, $method, $args = array(), $limit = 5) {
		...
		$parse['host'] = str_replace(array('http:/'.'/','https:/'.'/'), array('','ssl:/'.'/'), "$parse[scheme]:		if (!$fp = @fsockopen($parse['host'],$parse['port'],$errnum,$errstr,$limit)) {
