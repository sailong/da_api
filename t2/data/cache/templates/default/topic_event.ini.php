...
right_show_ajax('<?php echo $member['uid']; ?>','buddys_create_event','buddys_create_event');
<?php } ?> <?php if('joined' == $filter) { ?>
right_show_ajax('<?php echo $member['uid']; ?>','buddys_joined_event','buddys_joined_event');
<?php } ?>
right_show_ajax('<?php echo $member['uid']; ?>','recd_event','recd_event');
});
</script> <?php if('created' == $filter) { ?> <div class="side"> <h3> <?php if($member['uid']==MEMBER_ID) { ?>
我关注人发起的活动
<?php } else { ?><?php echo $member['gender_ta']; ?>关注人发起的活动
<?php } ?> </h3> <ul id="<?php echo $member['uid']; ?>_buddys_create_event" class="FTL"></ul> </div> <?php } ?> <?php if('joined' == $filter) { ?> <div class="side"> <h3> <?php if($member['uid']==MEMBER_ID) { ?>
我关注人参与的活动
<?php } else { ?><?php echo $member['gender_ta']; ?>关注人参与的活动
<?php } ?> </h3> <ul id="<?php echo $member['uid']; ?>_buddys_joined_event" class="FTL"></ul> </div> <?php } ?> <div class="side"> <h3>热点推荐活动</h3> <ul id="<?php echo $member['uid']; ?>_recd_event" class="FTL"></ul> </div> <?php /* 2013-07-19 in jishigou invalid request template */ if(!defined("IN_JISHIGOU")) exit("invalid request"); ?> <script type="text/javascript">
$(document).ready(function(){
