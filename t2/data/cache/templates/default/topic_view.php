...
</script> <span id="topic_content_<?php echo $topic_info['tid']; ?>_short"><?php echo $topic_info['content']; ?></span> <div id="topic_content_<?php echo $topic_info['tid']; ?>_full" class="full_img_s"></div> <!-- 
<?php if($topic_info['longtextid'] > 0) { ?> <script language="Javascript">
setTimeout(function () {
view_longtext('<?php echo $topic_info['longtextid']; ?>', '<?php echo $topic_info['tid']; ?>');
}, 100);	    		
</script> <?php } ?>
--> <?php if($topic_info['attachid'] && $topic_info['attach_list']) { ?> <table class="attachst" style="width:440px;"> <?php if(is_array($topic_info['attach_list'])) { foreach($topic_info['attach_list'] as $iv) { ?> <tr> <td class="attachst_img"><img src="<?php echo $iv['attach_img']; ?>"/></td> <td class="attachst_att"> <p class="attachList_att_name"><b><?php echo $iv['attach_name']; ?></b>&nbsp;（<?php echo $iv['attach_size']; ?>）</p> <p class="attachList_att_doc"><a href="javascript:void(0);"	onclick="downattach(<?php echo $iv['id']; ?>);">点此下载</a>（需<?php echo $iv['attach_score']; ?>积分，已下载<?php echo $iv['attach_down']; ?>次）</p> </td> </tr> <?php } } ?> </table> <?php } ?> <?php if($topic_info['imageid'] && $topic_info['image_list']) { ?> <style type="text/css">
...
</style> <div class="feedUserImg fuimg" style="width:auto; padding:0; border:none;"> <ul class="imgList"> <?php if(is_array($topic_info['image_list'])) { foreach($topic_info['image_list'] as $iv) { ?> <li><a id="TV_img_a_<?php echo $iv['id']; ?>" href="<?php echo $iv['image_original']; ?>" class="artZoom2" rel="<?php echo $iv['image_small']; ?>"><img id="TV_img_<?php echo $iv['id']; ?>" src="<?php echo $iv['image_original']; ?>" onload="TV_resizeImage(this, 550, <?php echo $iv['id']; ?>)" /></a></li> <?php } } ?> </ul> </div> <br /> <?php } ?> <?php if($topic_info['videoid']) { ?> <div class="feedUservideo" > <a onclick="javascript:showFlash('<?php echo $topic_info['VideoHosts']; ?>', '<?php echo $topic_info['VideoLink']; ?>', this, '<?php echo $topic_info['VideoID']; ?>');"> <div id="play_<?php echo $topic_info['VideoID']; ?>" class="vP"><img src="images/feedvideoplay.gif"  /></div> <img src="<?php echo $topic_info['VideoImg']; ?>" style="border:none"/> </a> </div> <?php } ?> <?php if($topic_info['is_vote'] > 0) { ?> <?php $__v_tid =$topic_info['tid'].'_'.$topic_info['random'] ?> <ul class="imgList" id="vote_detail_<?php echo $__v_tid; ?>"> <li><a href="javascript:;" onclick="getVoteDetailWidgets('<?php echo $__v_tid; ?>', <?php echo $topic_info['is_vote']; ?>);"><img src='./images/vote_pic_01.gif'/></a> </li> </ul> <div id="vote_area_<?php echo $__v_tid; ?>" style="display:none;"> <div class="blogTxt"> <div class="top"></div> <div class="mid" id="vote_content_<?php echo $__v_tid; ?>"></div> <div class="bottom"></div> </div> </div> <?php } ?> <?php if($topic_info['musicid']) { ?> <?php if($topic_info['xiami_id']) { ?> <div class="feedUserImg"><embed width="257" height="33" wmode="transparent" type="application/x-shockwave-flash" src="http://www.xiami.com/widget/0_<?php echo $topic_info['xiami_id']; ?>/singlePlayer.swf"></embed></div> <?php } else { ?> <div class="feedUserImg"> <div id="play_<?php echo $topic_info['MusicID']; ?>"></div> <img src="images/music.gif" title="点击播放音乐" onclick="javascript:showFlash('music', '<?php echo $topic_info['MusicUrl']; ?>', this, '<?php echo $topic_info['MusicID']; ?>');" style="cursor:pointer; border:none;" /> </div> <?php } ?> <?php } ?> </div> </li> <?php if(($tpid=$topic_info['top_parent_id'])>0) { ?> <?php $pt=$t_parent_list[$tpid]; ?> <li> <div class="blogTxt w540"> <div class="top_3"></div> <div class="mid w508"> <?php if($pt) { ?> <span> <a href="index.php?mod=<?php echo $pt['username']; ?>" onmouseover="get_user_choose(<?php echo $pt['uid']; ?>,'_reply_user',<?php echo $pt['tid']; ?>);" onmouseout="clear_user_choose();"><?php echo $pt['nickname']; ?></a> <?php echo $pt['validate_html']; ?> :  
<span id="user_<?php echo $pt['tid']; ?>_reply_user"></span> </span> <?php $TPT_ = $TPT_ ? $TPT_ : 'TPT_'; ?> <span id="topic_content_<?php echo $TPT_; ?><?php echo $pt['tid']; ?>_short"><?php echo $pt['content']; ?></span> <span id="topic_content_<?php echo $TPT_; ?><?php echo $pt['tid']; ?>_full"></span> <?php if($pt['longtextid'] > 0) { ?> <span> <a href="javascript:;" onclick="view_longtext('<?php echo $pt['longtextid']; ?>', '<?php echo $pt['tid']; ?>', this, '<?php echo $TPT_; ?>', '<?php echo $topic_info['tid']; ?>');return false;">查看全文</a> </span> <?php } ?> <?php if($pt['attachid'] && $pt['attach_list']) { ?> <table class="attachst" style="width:440px;"> <?php if(is_array($pt['attach_list'])) { foreach($pt['attach_list'] as $iv) { ?> <tr> <td class="attachst_img"><img src="<?php echo $iv['attach_img']; ?>"/></td> <td class="attachst_att" style="float:left;"> <p class="attachList_att_name"><b><?php echo $iv['attach_name']; ?></b>&nbsp;（<?php echo $iv['attach_size']; ?>）</p> <p class="attachList_att_doc"><a href="javascript:void(0);"	onclick="downattach(<?php echo $iv['id']; ?>);">点此下载</a>（需<?php echo $iv['attach_score']; ?>积分，已下载<?php echo $iv['attach_down']; ?>次）</p> </td> </tr> <?php } } ?> </table> <?php } ?> <?php if($pt['imageid'] && $pt['image_list']) { ?> <?php $pt['image_key']=$pt['tid'].'_'.$pt['random']; ?> <ul class="imgList" id="image_area_<?php echo $pt['image_key']; ?>"> <?php if(is_array($pt['image_list'])) { foreach($pt['image_list'] as $iv) { ?> <li><a href="<?php echo $iv['image_original']; ?>" class="artZoomAll" rel="<?php echo $iv['image_small']; ?>" rev="<?php echo $pt['image_key']; ?>"><img style="width:<?php echo $this->Config['thumbwidth']; ?>px; height:<?php echo $this->Config['thumbheight']; ?>px;" src="<?php echo $iv['image_small']; ?>" /></a></li> <?php } } ?> </ul> <?php } ?> <?php if($pt['videoid'] and $this->Config['video_status']) { ?> <div class="feedUservideo" > <a onClick="javascript:showFlash('<?php echo $pt['VideoHosts']; ?>', '<?php echo $pt['VideoLink']; ?>', this, '<?php echo $pt['VideoID']; ?>');" > <div id="play_<?php echo $pt['VideoID']; ?>" class="vP"></div> <img src="<?php echo $pt['VideoImg']; ?>" style="border:none" /> </a> </div> <?php } ?> <?php if($pt['musicid']) { ?> <?php if($pt['xiami_id']) { ?> <div class="feedUserImg"><embed width="257" height="33" wmode="transparent" type="application/x-shockwave-flash" src="http://www.xiami.com/widget/0_<?php echo $pt['xiami_id']; ?>/singlePlayer.swf"></embed></div> <?php } else { ?><div class="feedUserImg"> <img src="images/music.gif" title="点击播放音乐" onClick="javascript:showFlash('music', '<?php echo $pt['MusicUrl']; ?>', this, '<?php echo $pt['MusicID']; ?>');" style="cursor:pointer;border:none;" /> <div id="play_<?php echo $pt['MusicID']; ?>" class="vP"></div> </div> <?php } ?> <?php } ?> <?php if($pt['is_vote'] > 0) { ?> <ul class="imgList" id="vote_detail_<?php echo $pt['tid']; ?>"> <li><a href="javascript:;" onclick="getVoteDetailWidgets('<?php echo $pt['tid']; ?>', <?php echo $pt['is_vote']; ?>);"><img src='./images/vote_pic_01.gif'/></a> </li> </ul> <div id="vote_area_<?php echo $pt['tid']; ?>" style="display:none;"> <div class="vote_zf_box" id="vote_content_<?php echo $pt['tid']; ?>"></div> </div> <?php } ?> <p style="float:left; width:100%; display:block;"><a href="index.php?mod=topic&code=<?php echo $tpid; ?>" target="_blank">原文评论(<?php echo $pt['replys']; ?>)</a>&nbsp;
<a onclick="get_forward_choose(<?php echo $tpid; ?>);return false;" href="index.php?mod=topic&code=<?php echo $tpid; ?>" target="_blank">转发原文(<?php echo $pt['forwards']; ?>)</a></p> <?php } else { ?><span>原始微博已删除</span> <?php } ?> </div> <div class="bottom_2"></div> </div> </li> <?php } ?> <li><span class="spanLeft fontGray"> <?php echo $topic_info['dateline']; ?> <?php echo $topic_info['from_html']; ?> </span> <?php if($allow_op && $topic_info['managetype'] != 2) { ?> <span class="spanRight"> <span 
<?php if(MEMBER_ID <1 ) { ?>
...
</span> <span> <?php if($topic_info['uid']==MEMBER_ID || 'admin'==MEMBER_ROLE_TYPE) { ?> <a href="javascript:void(0)" onclick="deleteTopic(<?php echo $topic_info['tid']; ?>,'topic_list}_<?php echo $topic_info['tid']; ?>','view');return false;">删除</a> |&nbsp;
<?php if(time() - $topic_info['addtime'] < 3600 || 'admin'==MEMBER_ROLE_TYPE) { ?> <?php if($topic_info['replys'] <= 0 && $topic_info['forwards'] <= 0 || 'admin'==MEMBER_ROLE_TYPE) { ?> <a href="javascript:void(0);" onclick="modifyTopic(<?php echo $topic_info['tid']; ?>,'modify_topic_<?php echo $topic_info['tid']; ?>','reply_list');return false;" style="cursor:pointer;">编辑</a> |&nbsp;
<?php } ?> <?php } ?> <?php } ?> </span> <?php if($is_favorite) { ?> <span id="favorite_<?php echo $topic_info['tid']; ?>" 
<?php if(MEMBER_ID <1 ) { ?>
onclick="ShowLoginDialog();" 
<?php } ?>
> <a href="javascript:void(0)" onclick="favoriteTopic(<?php echo $topic_info['tid']; ?>,'delete');return false;">取消收藏</a></span> <?php } else { ?><span id="favorite_<?php echo $topic_info['tid']; ?>" 
<?php if(MEMBER_ID <1 ) { ?>
onclick="ShowLoginDialog();" 
<?php } ?>
> <a href="javascript:void(0)" onclick="favoriteTopic(<?php echo $topic_info['tid']; ?>,'add');return false;">收藏</a></span> <?php } ?> <?php if(in_array($root_type, get_topic_type('forward'))) { ?> <?php if($this->Config['sina_enable'] && sina_weibo_init()) { ?> <?php echo sina_weibo_share($topic_info['tid']); ?> <?php } ?> <?php if($this->Config['qqwb_enable'] && ($qqwb_config = qqwb_init()) && $qqwb_config['qqwb']['is_rebutton_display']) { ?> <?php $ioss="";$ios=array();if($topic_info['imageid'] && $topic_info['image_list'])foreach($topic_info['image_list'] as $iv)$ios[]=$iv['image_original']; $ioss=implode("|",$ios); ?>
| <a href="javascript:void(0)" onclick="postToWb();" title="转播到腾讯微博" style="height:16px;font-size:12px;line-height:16px;">转播到<img src="http://v.t.qq.com/share/images/s/weiboicon16.png" align="absmiddle"/></a> <script type="text/javascript">
function postToWb(){
...
</script> <?php if($topic_info['managetype'] != 2) { ?> <div class="blackBox"></div> <a name="replyTopic" id="replyTopic"></a> <div class="one_comment" 
<?php if(MEMBER_ID<1) { ?>
onclick="ShowLoginDialog();" 
<?php } ?>
> <li> <textarea name="content" id="i_already_view" rows="3" class="sp sp_3 view_review"></textarea> <input name="replytid" type="hidden" id="replytid" value="<?php echo $topic_info['tid']; ?>"/> </li> <li class="view_r"> <div class="viewNewLeft"> <div class="viewfb"> <script type="text/javascript">
$(document).ready(function(){
$(".reply_menu_bqb_c").click(function(){$("#reply_face").show();});
});
</script> <div class="menuf"> <div class="menuf_bq"> <b class="reply_menu_bqb_c"><a href="javascript:void(0);" onclick="topic_face('reply_face','i_already_view');return false;">表情</a></b> <div id="reply_face" class="reply_face"></div> </div> </div> </div> <div class="comment_p_b2 comment_p_b22" id="reply_image_uploadify_<?php echo $topic_info['tid']; ?>"> <div onclick="imageUploadifyHTML('<?php echo $topic_info['tid']; ?>', 'i_already_view', 'reply_image_uploadify_<?php echo $topic_info['tid']; ?>', 1);" class="menu_tq"><b class="menu_tqb_c">图片</b></div> </div> <?php if($this->Config['attach_enable']) { ?> <div class="comment_p_b2 comment_p_b22" id="reply_attach_uploadify_<?php echo $topic_info['tid']; ?>"> <div onclick="attachUploadifyHTML('<?php echo $topic_info['tid']; ?>', 'i_already_view', 'reply_attach_uploadify_<?php echo $topic_info['tid']; ?>', 1);" class="menu_fj menu_fj_reply_style"><b class="menu_fjb_c">附件</b></div> </div> <?php } ?> </div> <div class="viewNewRight"> <div class="view_r3"><input id="publishSubmit" onclick="publishSubmit('i_already_view','replytid','rl','topictype');return false;" type="button" value="评论" class="sBtn_2" title="按Ctrl+Enter快捷发布" /></div> <div class="view_r2"> <?php if(in_array($root_type, get_topic_type('forward'))) { ?> <div class="view_r1"><input name="topictype" type="checkbox" id="topictype" value="reply" onclick="select_checked();"/><label for="topictype" style="cursor:pointer;">同时转发微博</label> </div> <?php } else { ?> <input name="topictype" type="hidden" id="topictype" value="reply"/> <?php } ?> </div> </div> </li> </div> <?php } ?> </div> <script language="Javascript">
...
</script> <div> <div class="mainR"> <div> <div class="mainR"> <?php if($this->Config['ad_enable']) { ?> <?php if('myhome'== $this->Code) { ?> <?php if($this->Config['ad']['ad_list']['group_myhome']['middle_right']) { ?> <div class="R_AD"> <?php echo $this->Config['ad']['ad_list']['group_myhome']['middle_right']; ?></div> <?php } ?> <?php } elseif('tag'== $this->Get['mod']) { ?> <?php if($this->Config['ad']['ad_list']['tag_view']['middle_right']) { ?> <div class="R_AD"><?php echo $this->Config['ad']['ad_list']['tag_view']['middle_right']; ?></div> <?php } ?> <?php } ?> <?php } ?> <div id="topic_right_ajax_list"></div> <?php echo $this->hookall_temp['global_usernav_extra2']; ?> <?php if('pic' == $this->Get['type']) { ?> <script type="text/javascript">
$(document).ready(function(){
...
<table > <tr> <td><input name="remark_<?php echo $member['uid']; ?>" type="text" id="remark_<?php echo $member['uid']; ?>" class="text-area2" value="<?php echo $buddys['remark']; ?>" size="6" maxlength="6"/> </td> <td align="left"> <input type="button" class="shareI" value="保 存" onclick="publishSubmit_remark('remark_<?php echo $member['uid']; ?>',<?php echo $member['uid']; ?>);return false;" /> </td> </tr> </table> </form> </div> </li> </ul> </div> <?php } ?> <?php } ?> </div> </div> </div> </div> </div><?php /* 2013-07-19 in jishigou invalid request template */ if(!defined("IN_JISHIGOU")) exit("invalid request"); ?><script type="text/javascript" src="templates/default/js/jsgst.js?build+20120829"></script> <div id="show_message_area"></div> <?php echo $this->js_show_msg(); ?> <?php echo $GLOBALS['schedule_html']; ?> <?php if($GLOBALS['jsg_schedule_mark'] || jsg_getcookie('jsg_schedule')) echo jsg_schedule(); ?> <div id="ajax_output_area"></div> <?php if(MEMBER_ID ==0) { ?> <style type="text/css">
