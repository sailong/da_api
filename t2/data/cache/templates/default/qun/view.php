...
</script> </div> <?php } else { ?><div class="qun_notic_2">
开始发言吧..
<?php if($perm==0) { ?> <span style="color:#999999;">已申请加入，请等待审核</span> <?php } else { ?> <?php if($qun_info['join_type'] != 1) { ?> <a href="javascript:;" onclick="joinQun(<?php echo $qun_info['qid']; ?>)">加入群</a> <?php } else { ?><a href="javascript:;" onclick="showApplyQunDialog(<?php echo $qun_info['qid']; ?>)">加入群</a> <?php } ?> <?php } ?> </div> <?php } ?> <div class="TopicMan"> <div class="nfTagB qun_nva_p"> <ul> <li <?php echo $active['newtopic']; ?>> <span><a href="index.php?mod=qun&view=newtopic&qid=<?php echo $qun_info['qid']; ?>" title="最新微博">最新微博</a></span> </li> <li <?php echo $active['newreply']; ?>> <span><a href="index.php?mod=qun&view=newreply&qid=<?php echo $qun_info['qid']; ?>" title="最新评论">最新评论</a></span> </li> <?php if($this->Config['qun_attach_enable']) { ?> <li <?php echo $active['attach']; ?>> <span> <a href="index.php?mod=qun&view=attach&qid=<?php echo $qun_info['qid']; ?>" title="群内附件">群内附件</a> </span> </li> <?php } ?> <?php if($this->Config['event_open']) { ?> <li <?php echo $active['event']; ?>> <span> <a href="index.php?mod=qun&view=event&qid=<?php echo $qun_info['qid']; ?>" title="群内活动">群内活动</a> </span> </li> <?php } ?> <?php if($this->Config['vote_open']) { ?> <li <?php echo $active['vote']; ?>> <span> <a href="index.php?mod=qun&view=vote&qid=<?php echo $qun_info['qid']; ?>" title="群内投票">群内投票</a> </span> </li> <?php } ?> <li <?php echo $active['recd']; ?>> <span> <a href="index.php?mod=qun&view=recd&qid=<?php echo $qun_info['qid']; ?>" title="官方推荐的微博">官方推荐</a> <em class="navNew"></em> </span> </li> </ul> <div class="clear"></div> </div> <?php if(!in_array($view,array('event','vote','attach','image'))) { ?> <div class="nfBox index_m"> <div class="left" style="position:relative;"> <?php if(empty($this->Get['type'])) 	$all = "current"; ?> <?php if($this->Get['type'] == 'pic') 	$pic = "current"; ?> <?php if($this->Get['type'] == 'video') $video = "current"; ?> <?php if($this->Get['type'] == 'music') $music = "current"; ?> <?php if($this->Get['gid']) $gid = '&gid='.$this->Get['gid']; ?> <a title="全部" href="index.php?mod=qun&view=<?php echo $view; ?>&qid=<?php echo $qid; ?>" class="<?php echo $all; ?>">全部</a> <a title="含图片" href="index.php?mod=qun&view=<?php echo $view; ?>&qid=<?php echo $qid; ?>&type=pic" class="<?php echo $pic; ?>">图片</a> <a title="含视频" href="index.php?mod=qun&view=<?php echo $view; ?>&qid=<?php echo $qid; ?>&type=video" class="<?php echo $video; ?>">视频</a> <a title="含音乐" href="index.php?mod=qun&view=<?php echo $view; ?>&qid=<?php echo $qid; ?>&type=music" class="<?php echo $music; ?>">音乐</a> </div> <div class="clear"></div> </div> <?php } ?> <?php if(in_array($view,array('attach'))) { ?> <div class="nfBox index_m"> <div class="left" style="position:relative;"> <?php if(empty($this->Get['type'])) 	$all = "current"; ?> <?php if($this->Get['type'] == 'hot') 	$hot = "current"; ?> <?php if($this->Get['type'] == 'new') $new = "current"; ?> <?php if($this->Get['gid']) $gid = '&gid='.$this->Get['gid']; ?> <a title="全部" href="index.php?mod=qun&view=<?php echo $view; ?>&qid=<?php echo $qid; ?>" class="<?php echo $all; ?>">全部</a> <a title="下载最多附件" href="index.php?mod=qun&view=<?php echo $view; ?>&qid=<?php echo $qid; ?>&type=hot" class="<?php echo $hot; ?>">热门</a> <a title="最近上传附件" href="index.php?mod=qun&view=<?php echo $view; ?>&qid=<?php echo $qid; ?>&type=new" class="<?php echo $new; ?>">最新</a> </div> <div class="clear"></div> </div> <?php } ?> </div> <script language="Javascript">
...
{
<?php if(is_array($gets)) { foreach($gets as $k => $v) { ?> <?php echo $k; ?>:"<?php echo $v; ?>",
<?php } } ?>
start:s
},
function (d) {
...
</script> <?php if($view == 'event') { ?> <?php /* 2013-11-10 in jishigou invalid request template */ if(!defined("IN_JISHIGOU")) exit("invalid request"); ?> <div class="e_count">找到相关活动 <b class="fontRed"><?php echo $count; ?></b> 条</div> <?php if(is_array($event)) { foreach($event as $key => $val) { ?> <div class="e_list_box"> <div class="left_user_info"> <div class="avatar_left"> <a href="index.php?mod=event&code=detail&id=<?php echo $key; ?>"> <img src="<?php echo $val['image']; ?>" height="128" width="100"></img> </a> </div> <div class="avatar2_info"> <p class="left_t_nick_name"> <a href="index.php?mod=event&code=detail&id=<?php echo $key; ?>"><strong><?php echo $val['title']; ?></strong></a> </p> <p class="left_t2">
时间：<?php echo $val['fromt']; ?>-<?php echo $val['tot']; ?> </p> <p class="left_t2">
地点：<?php echo $val['address']; ?> </p> <p class="left_t2">
发起人：<a href="index.php?mod=<?php echo $val['username']; ?>" target="_blank"><?php echo $val['nickname']; ?></a><a href="index.php?mod=event&code=myevent&uid=<?php echo $val['uid']; ?>" target="_blank">(查看他的活动)</a> </p> <p class="left_t2"> <?php echo $val['event_type']; ?><br/>
报名人数：<?php echo $val['app_num']; ?> | 参与人数：<?php echo $val['play_num']; ?> </p> </div> </div> </div> <?php } } ?> <?php if($page_arr['html']) { ?> <div><ul><li><?php echo $page_arr['html']; ?></li> </ul></div> <?php } ?> <?php } elseif($view == 'vote') { ?> <div class="Listmain"> <?php if($count) { ?> <?php /* 2013-11-10 in jishigou invalid request template */ if(!defined("IN_JISHIGOU")) exit("invalid request"); ?> <?php if(is_array($vote_list)) { foreach($vote_list as $val) { ?> <div id="topic_list_25"> <div class="feedCell vote_list" id="topic_list_25"> <div class="avatarL"> <div class="avatar"> <a href="index.php?mod=vote&view=me&uid=<?php echo $val['uid']; ?>"><img src="<?php echo $members[$val['uid']]['face']; ?>" onerror="javascript:faceError(this);" /></a> </div> <div class="vText"><a href="index.php?mod=<?php echo $val['uid']; ?>&type=vote"><?php echo $members[$val['uid']]['nickname']; ?><?php echo $members[$val['uid']]['validate_html']; ?></a></div> </div> <div id="user_25_user"></div> <div id="Pmsend_to_user_area" style="width:430px; display:none"></div> <div id="global_select_4" class="alertBox" style="display:none"></div> <div class="Contant"> <div id="topic_lists_25" style="_overflow:hidden"> <div class="oriTxt"> <p class="vote_l_1"> <span><a title="<?php echo $val['subject']; ?>" href="index.php?mod=vote&code=view&vid=<?php echo $val['vid']; ?>" target="_blank" ><?php echo $val['subject']; ?></a><span> <?php if($val['is_expiration']) { ?> <span style="color:#666;">(已结束)</span> <?php } ?> <?php if($val['is_vote']) { ?> <span  style="color:#00CC00;">(已投票)</span> <?php } ?> </p> <p style="font-size:12px; color:#666;" class="vote_l_1"> <?php if(is_array($val['vote_show'])) { foreach($val['vote_show'] as $it => $item) { ?> <?php if($it<$val['vi_count']) { ?> <img src="templates/default/images/accept.png" /> <?php } else { ?><input type="<?php echo $val['input_type']; ?>" disabled="disabled"/> <?php } ?> <?php echo $item; ?> <br /> <?php } } ?>
...
</p> <div class="vote_num"><b><?php echo $val['voter_num']; ?></b></div> </div> <div class="from"> <div class="option"></div> <div class="mycome"> <span style="color:#666;">最后更新时间：<?php echo $val['last_update_time']; ?></span> <span style="margin-left:5px;"><a href="index.php?mod=vote&code=view&vid=<?php echo $val['vid']; ?>" target="_blank" >查看投票&rsaquo;&rsaquo;</a></span> </div> </div> </div> </div> </div> </div> <?php } } ?> <?php if($page_arr['html']) { ?> <div class="pageStyle"> <li><?php echo $page_arr['html']; ?></li> </div> <?php } ?> <?php } else { ?> <div style="margin-left:5px;">还没有投票。</div> <?php } ?> </div> <?php } elseif($view == 'image') { ?> <div class="Listmain"> <?php if($count) { ?> <?php } else { ?> <div style="margin-left:5px;">还没有图片。</div> <?php } ?> </div> <?php } elseif($view == 'attach') { ?> <div class="Listmain"> <?php if($count) { ?> <style>
.q_attach th{border-bottom:1px solid #ccc;}
.q_attach td{border-bottom:1px dashed #ccc;padding:3px 0px;}
</style> <table border="0" cellpadding="0" cellspacing="0" style="width:100%" class="q_attach"> <tr> <th width="8%">类型</th> <th width="45%">文件名称</th> <th width="8%">积分</th> <th width="24%">上传时间</th> <th width="8%">已下载</th> <th width="7%">操作</th> </tr> <?php if(is_array($attach_list)) { foreach($attach_list as $val) { ?> <tr> <td><img src="<?php echo $val['type']; ?>" width="32" height="32"></td> <td><a href="index.php?mod=topic&code=<?php echo $val['tid']; ?>" title="查看所属微博" target="_blank"><?php echo $val['name']; ?></a>(<?php echo $val['size']; ?>)</td> <td><?php echo $val['score']; ?>分</td> <td><?php echo $val['time']; ?></td> <td><?php echo $val['download']; ?>次</td> <td><a href="javascript:void(0);"  onclick="downattach(<?php echo $val['id']; ?>);">下载</a></td> </tr> <?php } } ?> </table> <?php if($page_arr['html']) { ?> <div class="pageStyle"><?php echo $page_arr['html']; ?></div> <?php } ?> <?php } else { ?> <div style="margin-left:5px;">还没有附件。</div> <?php } ?> </div> <?php } else { ?> <div id="listTopicMsgArea"></div> <div id="listTopicArea"> <?php if(!empty($topic_list)) { ?> <!--
这边使用独立的list文件主要是减少系统内部的耦合
这里不用每次都到公用目录的topic_list_ajax上加判断条件，因为有可能应用的list样式会和公用部分不一样
@Create By	~ZZ~ <?php echo $Date; ?>:2011-05-03
--> <div class="Listmain"> <?php if($topic_list) { ?> <?php if(is_array($topic_list)) { foreach($topic_list as $val) { ?> <?php $counts++; ?> <div class="feedCell" id="topic_list_<?php echo $val['tid']; ?>"> <?php if($this->Config['ad_enable']) { ?> <?php if($counts == 5) { ?> <div class="L_AD"><?php echo $this->Config['ad']['ad_list']['topic_']['middle_center']; ?> </div> <?php } ?> <?php if($counts == 15) { ?> <div class="L_AD"><?php echo $this->Config['ad']['ad_list']['topic_']['middle_center1']; ?> </div> <?php } ?> <?php } ?> <?php /* 2013-07-19 in jishigou invalid request template */ if(!defined("IN_JISHIGOU")) exit("invalid request"); ?> <?php $talkanswerid = ''; ?> <div class="wb_l_face"> <div class="avatar"> <?php if($this->Code != '') { ?> <?php if(MEMBER_ID != $val['uid']) { ?> <a href="javascript:void(0)" onmouseover="get_user_choose(<?php echo $val['uid']; ?>,'_user<?php echo $talkanswerid; ?>',<?php echo $val['tid']; ?>);" onmouseout="clear_user_choose();"> <img src="./images/noavatar.gif" data-original="<?php echo $val['face']; ?>" onerror="javascript:faceError(this);" class="lazyload" /> </a> <?php } else { ?> <img src="<?php echo $val['face']; ?>" onerror="javascript:faceError(this);" /> <?php } ?> <?php } else { ?><a href="index.php?mod=<?php echo $val['username']; ?>"><img src="<?php echo $val['face']; ?>" onerror="javascript:faceError(this);" /></a> <?php } ?> <?php if($this->Config['is_topic_user_follow'] && !$val['user_css']) { ?> <?php echo $val['follow_html']; ?> <?php } ?> </div> <?php if($val['user_css']) { ?> <p class="<?php echo $val['user_css']; ?>"><?php echo $val['user_str']; ?></p> <?php } ?> </div> <div id="user_<?php echo $val['tid']; ?>_user<?php echo $talkanswerid; ?>"></div> <div id="Pmsend_to_user_area" style="width:430px;display:none"></div> <div id="alert_follower_menu_<?php echo $val['uid']; ?>" style="display:none"></div> <div id="button_<?php echo $val['uid']; ?>" onclick="get_group_choose(<?php echo $val['uid']; ?>);" style="display:none"></div> <div id="global_select_<?php echo $val['uid']; ?>" class="alertBox" style="display:none"></div> <div id="get_remark_<?php echo $val['uid']; ?>" style="display:none"></div> <div class="Contant"> <div id="topic_lists_<?php echo $val['tid']; ?>" style="_overflow:hidden"> <div class="oriTxt"> <?php if('myfavorite'==$this->Code && $val['favorite_time']) { ?> <p style="color:#666; font-size:12px;">收藏于：<?php echo $val['favorite_time']; ?></p> <?php } ?> <p class="utitle"> <span class="un"> <a title="查看<?php echo $val['nickname']; ?>的微博" href="index.php?mod=<?php echo $val['username']; ?>" class="photo_vip_t_name"  onmouseover="get_at_user_choose('<?php echo $val['nickname']; ?>',this)"><?php echo $val['nickname']; ?></a> <?php if($val['validate_html']) { ?> <?php echo $val['validate_html']; ?>&nbsp;
...
</script> <div class="side"> <h3>
微群分类<a class="btn SC_rementuijian_box" href="javascript:void(0);" onclick="right_show_ajax('<?php echo $member['uid']; ?>','qun_category','qun_category'); return false;"></a> </h3> <div class="FTL SC_rementuijian_box"> <div id="<?php echo $member['uid']; ?>_qun_category"></div> </div> </div> <?php if(MEMBER_ID > 0 && !empty($member)) { ?> <div class="HboxR"> <div class="boxRimg qun_r"> <div class="lface"><a href="index.php?mod=<?php echo $member['username']; ?>" title="<?php echo $member['username']; ?>"><img onerror="javascript:faceError(this);" src="<?php echo $member['face']; ?>" title="<?php echo $member['nickname']; ?>" /></a></div> <div class="rcon"> <span class="spanimg"><?php echo $member['nickname']; ?> <?php echo $member['validate_html']; ?></span> <br /> <span style="color:#555;"><?php echo $member['province']; ?>&nbsp;<?php echo $member['city']; ?></span> <br /> <span class="qun_r_t_13"><a href="index.php?mod=<?php echo $member['username']; ?>" title="<?php echo $member['username']; ?>">我的微博</a></span> </div> </div> <div class="create_qun_b"><a href="index.php?mod=qun&code=create " class="create_button">创建微群</a></div> </div> <?php } ?> <?php if($this->Get['mod'] == 'qun') { ?> <div class="sideBox"> <div class="f14B"><a title="微群首页" href="index.php?mod=qun">微群首页</a></div> <div class="f14B"><a title="我的微群" href="index.php?mod=qun&code=profile">我的微群</a></div> </div> <?php } ?> <?php if(in_array($this->Code, array('index', 'tag')) ) { ?> <div class="HboxR" style="margin-top:25px;"> <div style="font-size:14px;">你可能感兴趣的群</div> <div class="qun_r"> <?php if($recd_qun_list) { ?> <ul> <?php if(is_array($recd_qun_list)) { foreach($recd_qun_list as $val) { ?> <li> <div class="lface"> <a href="index.php?mod=qun&qid=<?php echo $val['qid']; ?>" target="_blank"> <img src="<?php echo $val['icon']; ?>" title="<?php echo $val['name']; ?>"/> </a> </div> <div class="rcon"> <span><a href="index.php?mod=qun&qid=<?php echo $val['qid']; ?>" target="_blank"><?php echo $val['name']; ?></a></span> <br /> <span style="color:#555;"> <?php if($val['member_num'] > 0) { ?>
成员<?php echo $val['member_num']; ?>人
<?php } else { ?>还没有成员
<?php } ?> </span> </div> <div class="clear"></div> </li> <?php } } ?> </ul> <?php } else { ?><span>可以由管理员在后台推荐</span> <?php } ?> </div> </div> <?php } ?> <?php if($new_qun_list) { ?> <div class="HboxR" style="margin-top:25px;"> <div style="font-size:14px;">最新微群</div> <div class="qun_r"> <ul> <?php if(is_array($new_qun_list)) { foreach($new_qun_list as $val) { ?> <li> <div class="lface"> <a href="index.php?mod=qun&qid=<?php echo $val['qid']; ?>" target="_blank"> <img src="<?php echo $val['icon']; ?>" title="<?php echo $val['name']; ?>"/> </a> </div> <div class="rcon"> <span><a href="index.php?mod=qun&qid=<?php echo $val['qid']; ?>" target="_blank"><?php echo $val['name']; ?></a></span> <br /> <span style="color:#555;"><?php echo $val['member_num']; ?>人	&nbsp;&nbsp;|&nbsp;&nbsp;<?php echo $val['thread_num']; ?>条微博</span> <br /> <span> <a href="javascript:;" onclick="joinQun(<?php echo $val['qid']; ?>)">加入群</a></span> </div> <div class="clear"></div> </li> <?php } } ?> </ul> </div> </div> <?php } ?> <?php if(!empty($qun_info)) { ?> <div class="HboxR"> <div id="c_wp" class="qun_r_t"> <div class="fl mrb"> <div class="qun_r_t_11"><a href="index.php?mod=qun&code=members&qid=<?php echo $qid; ?>"><?php echo $qun_info['member_num']; ?></a></div> <div class="qun_r_t_12">成员</div> </div> <div class="fl mrb"> <div class="qun_r_t_11"><a href="index.php?mod=qun&qid=<?php echo $qid; ?>"><?php echo $qun_info['thread_num']; ?></a></div> <div class="qun_r_t_12">微博</div> </div> <!--
<div class="fl" style="padding-left:5px;"> <div style="font-size:14px; font-weight:700;"><a href=""><?php echo $qun_info['topic_num']; ?></a></div> <div class="qun_r_t_12">话题</div> </div>--> <div style="clear:both;"></div> </div> <div id="qun_att_wp" style="margin-top:15px;"> <div> <span class="q_th">分 类：</span> <span class="qun_r_t_13"> <a href="index.php?mod=qun&code=category&cat_id=<?php echo $top_cat['cat_id']; ?>"><?php echo $top_cat['cat_name']; ?></a>
&nbsp;>&nbsp;
<a href="index.php?mod=qun&code=category&cat_id=<?php echo $sub_cat['cat_id']; ?>"><?php echo $sub_cat['cat_name']; ?></a> </span> </div> <div> <span class="q_th">群 主：</span> <span class="qun_r_t_13"> <a href="index.php?mod=<?php echo $qun_info['foundername']; ?>"> <?php echo $founder_info['nickname']; ?> <?php echo $founder_info['validate_html']; ?> </a> </span> </div> <?php if($qun_admin_list) { ?> <div> <span class="q_th">管理员：</span> <?php if(is_array($qun_admin_list)) { foreach($qun_admin_list as $admin) { ?> <span class="qun_r_t_13"><a href="index.php?mod=<?php echo $admin['username']; ?>"><?php echo $admin['nickname']; ?></a><?php echo $admin['validate_html']; ?></span>
&nbsp;
<?php } } ?> </div> <?php } ?> <?php if($followme_nums > 0) { ?> <div> <span class="q_th">
群里有：
<a href="index.php?mod=qun&code=members&type=followed&qid=<?php echo $qid; ?>"><?php echo $followme_nums; ?>位我关注</a> </span> <span></span> </div> <?php } ?> <?php if(!empty($tag_ary)) { ?> <div> <span class="q_th">群标签：</span> <span class="qun_r_t_13"> <?php if(is_array($tag_ary)) { foreach($tag_ary as $tag) { ?> <a href="index.php?mod=qun&code=tag&tag_id=<?php echo $tag['tag_id']; ?>"><?php echo $tag['tag_name']; ?></a>
&nbsp;
<?php } } ?> </span> </div> <?php } ?> <div> <span class="q_th">群简介：</span> <?php if($qun_info['desc']) { ?> <span><?php echo $qun_info['desc']; ?></span> <?php } else { ?><span>欢迎来到<?php echo $qun_info['name']; ?>微群</span> <?php } ?> </div> </div> </div> <?php if($recd_event_list) { ?> <div class="HboxR" style="margin-top:15px;"> <div style="font-size:14px;">群内推荐活动</div> <div> <ul> <?php if(is_array($recd_event_list)) { foreach($recd_event_list as $val) { ?> <li class="qun_r_t_13"><a href="index.php?mod=event&code=detail&id=<?php echo $val['eid']; ?>"><?php echo $val['title']; ?></a></li> <?php } } ?> </ul> </div> </div> <?php } ?> <?php if($recd_vote_list) { ?> <div class="HboxR" style="margin-top:15px;"> <div style="font-size:14px;">群内推荐投票</div> <div> <ul> <?php if(is_array($recd_vote_list)) { foreach($recd_vote_list as $val) { ?> <li class="qun_r_t_13"><a href="javascript:void(0);" onclick="vote_ajax_menu(<?php echo $val['vid']; ?>,<?php echo $uid; ?>);"><?php echo $val['subject']; ?></a></li> <?php } } ?> </ul> </div> </div> <?php } ?> <?php if($new_members) { ?> <div class="HboxR" style="margin-top:15px;"> <div style="font-size:14px;">欢迎新成员</div> <div> <ul class="sideul2"> <?php if(is_array($new_members)) { foreach($new_members as $val) { ?> <li class="h_h2"><a href="index.php?mod=<?php echo $val['username']; ?>" target="_blank"><img onerror="javascript:faceError(this);" src="<?php echo $val['face']; ?>" title="<?php echo $val['nickname']; ?>" class="manface" onmouseover="get_user_choose(<?php echo $val['uid']; ?>,'_user',<?php echo $val['uid']; ?>)" onmouseout="clear_user_choose()"/></a> <b><a href="index.php?mod=<?php echo $val['username']; ?>" target="_blank"><?php echo $val['nickname']; ?></a></b> <div id="user_<?php echo $val['uid']; ?>_user" class="layS2"></div> </li> <?php } } ?> </ul> </div> </div> <?php } ?> <?php } ?> <?php if($this->Code == 'profile') { ?> <div class="HboxR" style="margin-top:15px;"> <div style="color:#444;">
满足以下条件才能创建微群：
<br /> <?php if(is_array($ploys)) { foreach($ploys as $key => $val) { ?> <?php echo $key+1; ?>
.<?php echo $val; ?> <br /> <?php } } ?> <a href="index.php?mod=qun&code=ploy">查看微群策略&gt;&gt;</a> </div> </div> <div class="HboxR" style="margin-top:25px; font-size:14px;"> <?php if(is_array($view_list)) { foreach($view_list as $view_nav) { ?> <div class="pf_r_nav"><a href="index.php?mod=qun&code=profile&view=<?php echo $view_nav['code']; ?>"><?php echo $view_nav['title']; ?></a></div> <?php } } ?> </div> <?php } ?> <?php if($this->Code=='category') { ?> <?php if($hot_tag_ary) { ?> <div class="HboxR"> <div style="margin-top:30px; font-size:14px; margin-bottom:10px;">热门群标签</div> <div id="hot_24_wp"> <?php if(is_array($hot_tag_ary)) { foreach($hot_tag_ary as $tag) { ?> <span><a href="index.php?mod=qun&code=tag&tag_id=<?php echo $tag['tag_id']; ?>" ><?php echo $tag['tag_name']; ?></a></span>
&nbsp;
<?php } } ?> </div> </div> <?php } ?> <?php } ?> <?php if($this->Config['ad_enable']) { ?> <div class="R_AD"> <?php echo $this->Config['ad']['ad_list']['qun']['middle_right']; ?> </div> <?php } ?> </div> </div> </div> </div><?php /* 2013-07-19 in jishigou invalid request template */ if(!defined("IN_JISHIGOU")) exit("invalid request"); ?><script type="text/javascript" src="templates/default/js/jsgst.js?build+20120829"></script> <div id="show_message_area"></div> <?php echo $this->js_show_msg(); ?> <?php echo $GLOBALS['schedule_html']; ?> <?php if($GLOBALS['jsg_schedule_mark'] || jsg_getcookie('jsg_schedule')) echo jsg_schedule(); ?> <div id="ajax_output_area"></div> <?php if(MEMBER_ID ==0) { ?> <style type="text/css">
