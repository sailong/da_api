...
</script> <div class="poll_submit" style=" width:540px; text-align:right; padding:0"> <?php if($allowedvote && !$hasvoted) { ?> <input type="hidden" name="votesubmit" value="true" /> <span style="width:100px;"> <input type="checkbox" name="toweibo" id="toweibo_view" value="1" style="vertical-align:middle; margin:-1px 0 0 0;" checked="checked"> <label for="toweibo_view">分享到微博</label> </span> <span style="width:100px;"> <input type="checkbox" name="anonymous" id="anonymous_view" value="1" style="vertical-align:middle;margin:-1px 0 0 0;"> <label for="anonymous_view">匿名</label> </span> <input type="button" class="vote_btn" id="save" value="" onclick="vote();"/> <input type="hidden" id="check_PublishBox_uid" name="check_PublishBox_uid" value="<?php echo $uid; ?>"> <?php } else { ?><input type="submit" class="shareI" id="save" value="已投票"  disabled="disabled"/> <?php } ?> </div> </form> </div> <script type="text/javascript">
...
</script> <div id="other_vote_wp"> <div class="set_warp" style="width:540px; margin:0 auto; padding:20px 0"> <div class="voteMenu"> <ul> <li id="one1" class="selected" onclick="setTab('one',1,2)">大家的最新投票</li> <?php if(MEMBER_ID>0) { ?> <li id="one2" onclick="setTab('one',2,2);getVoteJoined(1,{c:2});">关注人的最新投票</li> <?php } ?> </ul> </div> <div id="con_one_1" class="vote_con"></div> <div id="con_one_2" class="vote_con" style="display:none;"></div> </div> </div> <script language="javascript">
...
var url = "ajax.php?mod=vote&code=joined&vid=<?php echo $vid; ?>&type="+type+"&page="+page;
$.get(
url,
{},
function (r) {
...
这里显示我关注分类的相关微博。<BR />
对你感兴趣的分类进行关注，就可以在这里直接查看相关微博。<BR /> <?php } ?> </div> <?php } ?> </div> <?php echo $this->js_show_msg(); ?> </div> </div> </div> </div><?php /* 2013-11-10 in jishigou invalid request template */ if(!defined("IN_JISHIGOU")) exit("invalid request"); ?> <div class="Hotright"> <?php if(MEMBER_ID) { ?> <div class="HboxR"> <?php if($this->Code != 'view') { ?> <div class="boxRimg" style="margin:10px 0"> <div class="boxRimg_img"> <a href="index.php?mod=<?php echo $member['username']; ?>" title="<?php echo $member['username']; ?>"><img onerror="javascript:faceError(this);" src="<?php echo $member['face']; ?>" title="<?php echo $member['nickname']; ?>" /></a> </div> <div class="boxRimg_txt"> <p><span class="spanimg"><?php echo $member['nickname']; ?> <?php echo $member['validate_html']; ?></span> <?php if($member['gender'] == 1) { ?> <img src="templates/default/images/user.gif"  title="<?php echo $member['nickname']; ?>" style="width:15px; height:15px; margin:0;"/><?php } elseif($member['gender'] == 2) { ?><img src="templates/default/images/user_female.gif"  title="<?php echo $member['nickname']; ?>" style="width:15px; height:15px; margin:0"/> <?php } ?> </p> <p> <span><?php echo $member['province']; ?>&nbsp;<?php echo $member['city']; ?></span> </p> <p><a href="index.php?mod=<?php echo $member['username']; ?>" title="<?php echo $member['username']; ?>">我的微博</a></p> </div> </div> <?php } ?> <div class="create_qun_b"> <a class="create_button" href="index.php?mod=vote&code=create">发起投票</a> </div> </div> <?php } else { ?><div class="HboxR"> <span>还没有微博客帐号？<a href="index.php?mod=member">注册</a></span> <br /> <span>已有帐号，<a href="index.php?mod=login">请点此登录</a></span> </div> <?php } ?> <?php if($this->Code=='view') { ?> <div class="HboxR"> <div class="vote_line"></div> <ul class="vote_r_nav"> <li class="vote_home_ico"><a href="index.php?mod=vote">投票首页</a></li> <?php if(MEMBER_ID>0) { ?> <li class="vote_my_ico"><a href="index.php?mod=vote&view=me">我的投票</a></li> <li class="vote_her_ico"><a href="index.php?mod=vote&view=fllow">我关注的人的投票</a></li> <?php } ?> </ul> </div> <?php } ?> <div class="HboxR"> <div class="vote_line">热点推荐</div> <ul> <?php if(is_array($recd_list)) { foreach($recd_list as $val) { ?> <li> <span class="boxRl listyle"><a href="index.php?mod=vote&code=view&vid=<?php echo $val['vid']; ?>"><?php echo $val['subject']; ?></a></span> <span style="float:right;">(共<?php echo $val['voter_num']; ?>票)</span> </li> <?php } } ?> </ul> </div> <div class="HboxR"> <div class="vote_line">投票达人</div> <div id="vote_daren_wp"></div> </div> <script language="javascript">
getVoteDaRen('vote_daren_wp');
</script> <div class="HboxR"> <?php if($this->Config['ad_enable']) { ?> <div class="R_AD"> <?php echo $this->Config['ad']['ad_list']['vote']['middle_right']; ?> </div> <?php } ?> </div> </div> </div> </div> <?php if($this->Config['ad_enable']) { ?> <div align="center" class="T_AD"> <?php echo $this->Config['ad']['ad_list']['vote']['footer']; ?> </div> <?php } ?> <?php /* 2013-07-19 in jishigou invalid request template */ if(!defined("IN_JISHIGOU")) exit("invalid request"); ?><script type="text/javascript" src="templates/default/js/jsgst.js?build+20120829"></script> <div id="show_message_area"></div> <?php echo $this->js_show_msg(); ?> <?php echo $GLOBALS['schedule_html']; ?> <?php if($GLOBALS['jsg_schedule_mark'] || jsg_getcookie('jsg_schedule')) echo jsg_schedule(); ?> <div id="ajax_output_area"></div> <?php if(MEMBER_ID ==0) { ?> <style type="text/css">
