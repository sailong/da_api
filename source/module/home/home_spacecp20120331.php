...
$acs = array('space', 'doing', 'upload', 'comment', 'blog', 'album', 'relatekw', 'common', 'class',
	...
	'credit', 'usergroup', 'domain', 'click','magic', 'top', 'videophoto', 'index', 'plugin', 'search', 'promotion', 'score', 'video', 'weibo', 'spacelink','jigou','huiyuan','qiye','csqy','jbqc','test','ssinfo','action','vupload','hygl', 'apply', 'field','zanzhushang','jguser','qylogo','bgset','ershou','laba');
