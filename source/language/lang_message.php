...
$lang = array (
  ...
  'profile_username_toolong' => '抱歉，您的用户名超过 200 个字符，请输入一个较短的用户名',
...
/*大正报名 Angf doit 2012/2/22*/
  'register_succeed_dazbm'=> ' 下一步     请完善你的报名信息',

  'no_register_for_page_dazbm'=> ' sorry 请先登录 再报名',

  'apply_bm_succeed'=> ' 你的报名表单已经提交   请等待审核',

  'apply_bm_info_error'=> ' 填写的信息有误   请重新输入',

  'please_checking_info'=> ' 请认真填写你的 报名信息 ',

  'bm_uid_already'=> ' 您已经报名  请勿从新报名 ',

  'bm_eidt_succeed_to_home'=> ' 编辑成功 等待审核... ',

  'bm_eidt_succeed_to_pay'=> ' 已经提交 等待审核... ', //下一步支付报名费用 已经提交
