 ...
 * $_config['db']['1']['dbuser'] = 'dazheng'; // 用户
 * $_config['db']['1']['dbpw'] = 'dazheng';// 密码
...
$_config['db'][1]['dbuser']  		= 'dazheng';		
$_config['db'][1]['dbpw'] 	 	= 'dazheng';		
 ...
 * $_config['db']['slave']['1']['dbuser'] = 'dazheng';
 * $_config['db']['slave']['1']['dbpw'] = 'dazheng';
