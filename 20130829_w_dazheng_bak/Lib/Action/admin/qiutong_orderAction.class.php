 ...
 */
class qiutong_orderAction extends AdminAuthAction
{
	...
	{
		$list=D("qiutong_order")->qiutong_order_list_pro();
	...
	public function qiutong_order_add_action()
	{
		if(M()->autoCheckToken($_POST))
		{
			...
			if($list!=false)
			{
				$this->success("添加成功",U('admin/qiutong_order/qiutong_order'));
			}
			else
			{				
				$this->error("添加失败",U('admin/qiutong_order/qiutong_order_add'));
			}
		}
		else
		{
			$this->error("不能重复提交",U('admin/qiutong_order/qiutong_order_add'));
		}
	...
	public function qiutong_order_edit_action()
	{
		if(M()->autoCheckToken($_POST))
		{
			...
			if($list!=false)
			{
				$this->success("修改成功",U('admin/qiutong_order/qiutong_order'));
			}
			else
			{				
				$this->error("修改失败",U('admin/qiutong_order/qiutong_order'));
			}
		}
		else
		{
			$this->error("不能重复提交",U('admin/qiutong_order/qiutong_order'));
		}
