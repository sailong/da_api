...
/*接口mod 对应的 接口文件*/
$modarray = array('register', 'login','field','ad','club','club1','system','user','finance','message','score','event','manage_event','manage_event1','wap','go','reg_activate','card','tool');
...
//引入接口需要装载的文件
include '_field2/'.$versions.'/api_config.php';
include '_field2/'.$versions.'/api_func.php';
include '_field2/'.$versions.'/api_error.php';
include '_field2/'.$versions.'/'.$mod.'_api.php';
