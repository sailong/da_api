...
var p003399Gif         = "/wap/images/1x1_003399.gif";
...
*/
 function selectBoxNotify(formField,formFieldValue,index){
	...
	if('ee2012_dealer_province' == formField){
		...
		jQuery("#ee2012_dealer_element").html( writeSelectBox('ee2012_dealer',[please_choose,-1],1992 , 314, 6,-1,true,false,true));
		jQuery("#ee2012_event_station_element").html( writeSelectBox('ee2012_event_station',[please_choose,-1],1991 , 314, 6,-1,true,false,true));
	...
	jQuery.each( sectionContent.items, function(item, itemContent){
		...
		jQuery.each( itemContent.elements, function(element, elementContent){
			...
			if (elementContent.type=="Checkbox"){
				...
				if (sectionToEdit){
					jQuery("#"+elementContent.id+"_form_item").html('<div class="form_item_element" id="'+elementContent.id+'_element">'+writeCheckbox('form',itemContent.label,elementContent.value,elementContent.id,elementContent.id,2000-itemContent.index,314,null,itemContent.hasError,'',itemContent.mandatory,false)+'</div>');
				} else {
					jQuery("#"+elementContent.id+"_form_item").html('<div class="form_item_element" id="'+elementContent.id+'_element">'+writeCheckbox('form',itemContent.label,elementContent.value,elementContent.id,elementContent.id,2000-itemContent.index,314,null,itemContent.hasError,'',itemContent.mandatory,CheckBoxReadOnly)+'</div>');
				}
			}
			// build selection
			...
			if (elementContent.type=="Selection" && element==item){
				...
				if (elementContent.editor=="check"){
						...
						for (checkindex=0;checkindex<optLength;checkindex++){
							if (sectionToEdit){
								//jQuery("#"+elementContent.id+"_form_item").html(writeCheckbox('form',itemContent.label,elementContent.value,elementContent.id,elementContent.id,2000-itemContent.index,314,null,itemContent.hasError,'',itemContent.mandatory,false));
								jQuery("#"+elementContent.id+"_element").append(writeCheckbox('form',myExtendedOptions[checkindex].name, myExtendedOptions[checkindex].selected,elementContent.id+"."+myExtendedOptions[checkindex].value,elementContent.id+"."+myExtendedOptions[checkindex].value,2000-itemContent.index,314,null,itemContent.hasError,'',false,false));
							} else {
				  ...
				  // clear select
					...
					if (sectionToEdit){
						jQuery("#"+elementContent.id+"_element").html(writeSelectBox(elementContent.id,newOptions,getItemZindex(elementContent.id),314, 6,selectedItem,true,itemContent.hasError,false));
					} else {
						jQuery("#"+elementContent.id+"_element").html(writeSelectBox(elementContent.id,newOptions,getItemZindex(elementContent.id),314, 6,selectedItem,true,itemContent.hasError,SelectBoxReadOnly));
					}
				}
			}
		});	
	...
	$.each( sectionContent.items, function(item, itemContent){
		...
		$.each( itemContent.elements, function(element, elementContent){
			...
			if (elementContent.type=="Checkbox"){
				...
				if (sectionToEdit){
					$("#"+elementContent.id+"_form_item").html('<div class="form_item_element" id="'+elementContent.id+'_element">'+writeCheckbox('form',itemContent.label,elementContent.value,elementContent.id,elementContent.id,2000-itemContent.index,314,null,$('#'+ item + "_form_item").hasClass('error'),'',itemContent.mandatory,!($('#'+ section).hasClass('editmode') || $('#formstatus').hasClass('firstRun')))+'</div>');
				} else {
					$("#"+elementContent.id+"_form_item").html('<div class="form_item_element" id="'+elementContent.id+'_element">'+writeCheckbox('form',itemContent.label,elementContent.value,elementContent.id,elementContent.id,2000-itemContent.index,314,null,$('#'+ item + "_form_item").hasClass('error'),'',itemContent.mandatory,!($('#'+ section).hasClass('editmode') || $('#formstatus').hasClass('firstRun')))+'</div>');
				}
			}
			...
			if (elementContent.type=="Selection" && element==item){
				...
				if (elementContent.editor=="check"){
						...
						for (checkindex=0;checkindex<optLength;checkindex++){
							if (sectionToEdit){
								$("#"+elementContent.id+"_element").append(writeCheckbox('form',myExtendedOptions[checkindex].name, myExtendedOptions[checkindex].selected,elementContent.id+"."+myExtendedOptions[checkindex].value,elementContent.id+"."+myExtendedOptions[checkindex].value,2000-itemContent.index,314,null,$('#'+ item + "_form_item").hasClass('error'),'',false,false));
							} else {
								$("#"+elementContent.id+"_element").append(writeCheckbox('form',myExtendedOptions[checkindex].name, myExtendedOptions[checkindex].selected,elementContent.id+"."+myExtendedOptions[checkindex].value,elementContent.id+"."+myExtendedOptions[checkindex].value,2000-itemContent.index,314,null,$('#'+ item + "_form_item").hasClass('error'),'',false,CheckBoxReadOnly));
							}
				  ...
				  // clear select
					...
					//$("#"+elementContent.id+"_element").html(writeSelectBox(elementContent.id,newOptions,getItemZindex(subElementContent.id),314, 6,selectedItem,true,$('#'+ item + "_form_item").hasClass('error'),!($('#'+ section).hasClass('editmode') || $('#formstatus').hasClass('firstRun')) ));
					$("#"+elementContent.id+"_element").html(writeSelectBox(elementContent.id,newOptions,1000,314, 6,selectedItem,true,$('#'+ item + "_form_item").hasClass('error'),!($('#'+ section).hasClass('editmode') || $('#formstatus').hasClass('firstRun')) ));
